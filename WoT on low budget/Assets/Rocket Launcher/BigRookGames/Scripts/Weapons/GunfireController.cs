...
namespace BigRookGames.Weapons
{
    public class GunfireController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (autoFire && ((timeLastFired + cooldown) <= Time.time))
            {
                FireWeapon();
            }
            if (Input.GetKey(KeyCode.Mouse0) && ((timeLastFired + cooldown) <= Time.time))
                FireWeapon();
        ...
        public void FireWeapon()
        {
            ...
            {
                GameObject newProjectile = Instantiate(projectilePrefab, RoundSpawn.transform.position, RoundSpawn.transform.rotation, transform);
            }
            ...
            if (projectileToDisableOnFire != null)
            {
                ...
                Invoke("ReEnableDisabledProjectile", cooldown-1);
            }
